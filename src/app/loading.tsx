export default function Loading() {
  return (
    <div className="flex flex-col pt-32 w-full h-full items-center justify-center bg-white dark:bg-[#1b1f23]">
      <div
        className="flex items-center justify-center w-full bg-gray-200 py-[20px] max-mobile:py-1 overflow-hidden whitespace-nowrap relative dark:bg-[#2c2e31] animate-pulse shadow-md"
      >
