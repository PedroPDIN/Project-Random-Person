...
export default async function User(context: ContextParams) {
  ...
  return (
    <main className="pt-28 flex flex-col items-center justify-center dark:bg-[#1b1f23] transition ease-out">
      <div className="w-[50%] max-large-screen:w-[60%] tablet:max-laptop:w-[70%] mobile:max-tablet:w-[80%] micro-screen:max-mobile:w-[80%] max-micro-screen:w-[80%] mb-6">
        <InfoUser
      ...
      <div className="w-[50%] mb-6 max-large-screen:w-[60%] tablet:max-laptop:w-[70%] mobile:max-tablet:w-[80%] micro-screen:max-mobile:w-[80%] max-micro-screen:w-[80%]">
        <LocationUser
      ...
      <div className="w-[50%] max-large-screen:w-[60%] tablet:max-laptop:w-[70%] mobile:max-tablet:w-[80%] micro-screen:max-mobile:w-[80%] max-micro-screen:w-[80%] h-[24rem] rounded-md overflow-hidden bg-white border-solid border-2 border-[rgba(0,0,0,.25)] shadow-lg mb-2">
          <MapUser
          position={position}
      ...
      <div className="w-[50%] max-large-screen:w-[60%] tablet:max-laptop:w-[70%] mobile:max-tablet:w-[80%] micro-screen:max-mobile:w-[80%] max-micro-screen:w-[80%]">
