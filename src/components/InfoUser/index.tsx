    ...
    <div className="flex micro-screen:max-mobile:flex-col max-micro-screen:flex-col justify-around items-center bg-white border-solid border-2 border-[rgba(0,0,0,.25)] rounded-md shadow-lg px-4 py-12 dark:bg-[#2c2e31] transition ease-out">
      <div className="flex flex-col justify-center max-micro-screen:items-center micro-screen:max-mobile:items-center micro-screen:max-mobile:pb-4">
        <Image
          ...
          width={190}
          height={190}
          className="rounded-full p-1 border-solid border-2 border-[rgba(0,0,0,.25)] z-10 bg-white max-micro-screen:w-[120px] max-micro-screen:h-[120px] micro-screen:max-mobile:w-[130px] micro-screen:max-mobile:h-[130px]"
        />
      ...
      <div className="border-separate border-2 border-[rgba(0,0,0,.25)] h-[200px] rounded-full dark:border-white max-micro-screen:hidden micro-screen:max-mobile:hidden"></div>
